...
const SvgFirstAidKitDuotone = (props: SvgProps) => (
  <Svg
    fill="black"
    viewBox="0 0 256 256"
    width={24}
  ...
  >
    <Path
      d="M224 80v128a8 8 0 0 1-8 8H40a8 8 0 0 1-8-8V80a8 8 0 0 1 8-8h176a8 8 0 0 1 8 8Z"
      opacity={0.2}
    />
...
const Memo = memo(SvgFirstAidKitDuotone);
export default Memo;
