...
const SvgFastForwardCircleDuotone = (props: SvgProps) => (
  <Svg
    fill="black"
    viewBox="0 0 256 256"
    width={24}
  ...
  >
    <Path
      d="M128 32a96 96 0 1 0 96 96 96 96 0 0 0-96-96ZM80 160V96l48 32Zm64 0V96l48 32Z"
      opacity={0.2}
    />
...
const Memo = memo(SvgFastForwardCircleDuotone);
export default Memo;
