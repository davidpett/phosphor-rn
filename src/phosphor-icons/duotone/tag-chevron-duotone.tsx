...
const SvgTagChevronDuotone = (props: SvgProps) => (
  <Svg
    fill="black"
    viewBox="0 0 256 256"
    width={24}
  ...
  >
    <Path
      d="m230.66 132.44-42.67 64a8 8 0 0 1-6.66 3.56H24l46.65-67.56a8 8 0 0 0 0-8.88L24 56h157.33a8 8 0 0 1 6.67 3.56l42.67 64a8 8 0 0 1-.01 8.88Z"
      opacity={0.2}
    />
...
const Memo = memo(SvgTagChevronDuotone);
export default Memo;
