...
const SvgPersonSimpleRunDuotone = (props: SvgProps) => (
  <Svg
    fill="black"
    viewBox="0 0 256 256"
    width={24}
    ...
    {...props}
  >
    <Path d="M176 56a24 24 0 1 1-24-24 24 24 0 0 1 24 24Z" opacity={0.2} />
...
const Memo = memo(SvgPersonSimpleRunDuotone);
export default Memo;
