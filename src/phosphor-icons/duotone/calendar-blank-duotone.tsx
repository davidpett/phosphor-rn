...
const SvgCalendarBlankDuotone = (props: SvgProps) => (
  <Svg
    fill="black"
    viewBox="0 0 256 256"
    width={24}
    ...
    {...props}
  >
    <Path d="M216 48v40H40V48a8 8 0 0 1 8-8h160a8 8 0 0 1 8 8Z" opacity={0.2} />
...
const Memo = memo(SvgCalendarBlankDuotone);
export default Memo;
