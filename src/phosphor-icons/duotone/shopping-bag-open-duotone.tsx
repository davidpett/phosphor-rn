...
const SvgShoppingBagOpenDuotone = (props: SvgProps) => (
  <Svg
    fill="black"
    viewBox="0 0 256 256"
    width={24}
    ...
    {...props}
  >
    <Path d="M224 56v24H32V56a8 8 0 0 1 8-8h176a8 8 0 0 1 8 8Z" opacity={0.2} />
...
const Memo = memo(SvgShoppingBagOpenDuotone);
export default Memo;
